...
for the deployment of RAI_dashboard pipeline script in production
...
if __name__ == "__main__":
    ...
    parser.add_argument("--endpoint_name", type=str, default="rai-deployment-endpoint", help="unique endpoint name")
    parser.add_argument("--description", type=str,
                        default="Batch endpoint for operationalizing the RAI pipeline",
